...
class DeepLagrangianNetwork(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.n_hidden = args.n_depth
        self._b0 = args.b_init
        self._b0_diag = args.b_diag_init

        self._w_init = args.w_init
        self._g_hidden = args.gain_hidden
        self._g_output = args.gain_output
        self._p_sparse = 0.2 # args.p_sparse
        self._epsilon = args.diagonal_epsilon
    ...
    def forward(self, q, qd, qdd):
        ...
        tau_pred = out[0]
        # out: return tau_pred, H, c, g, T, V, dTdt, dVdt
        dEdt = out[6] + out[7]
